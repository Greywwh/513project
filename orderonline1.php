...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: http://localhost/as7/crud2/login.php");
    exit;
}
...
<div id="product-grid">
	...
	?>
		...
		<div class="image">
			...
			<a href='get-product-info.php? id=<?php echo $product_array[$key]["id"];?>'target="_blank">click</a>
		    <div class="image"><button class="quick_look" data-id="<?php echo $product_array[$key]["id"] ; ?>">Quick Look</button>
			</div>
